...
int ll_remove(LinkedList* this,int index)
{
    ...
    {
        pNode = getNode(this,index);
        nextNode = getNode(this,index+1);	//Entro si el indice es igual a 0
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
        index=ll_indexOf(this, pElement);//si la funcion no encuentra indice
        returnAux = 0;
...
int ll_count(LinkedList* this, int (*fn) (void* element))
{
    ...
    int len;
    if(this != NULL && ll_isEmpty(this) !=1 && fn != NULL)
    {
        len = ll_len(this);
        for(i=0; i<len; i++)
        {
            aux = fn(ll_get(this, i)); //en cada iteracion voy a estar invocando a la función "fn" que trae como parámetro un void* pElement con la cantidad que debe contarse
            if(aux > -1)
            {
...
LinkedList* ll_filter(LinkedList* this, int (*fn)(void* element))
{
    ...
    if(this != NULL && fn != NULL && listaFiltrada != NULL)
    {
        len = ll_len(this);
        for(i=0; i<len; i++)
        {
